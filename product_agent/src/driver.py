...
# MAGIC ############################################
# MAGIC LLM_ENDPOINT_NAME = "databricks-qwen3-next-80b-a3b-instruct"
# MAGIC
# MAGIC SYSTEM_PROMPT = """"""
# MAGIC
# MAGIC
...
# MAGIC UC_TOOL_NAMES = ["product_agent.product_schema.get_service_history", "product_agent.product_schema.get_return_policy"]
# MAGIC
...
# MAGIC             index_name="product_agent.product_schema.product_index",
