...
# MAGIC
# MAGIC **Purpose:** Extract text from product documentation PDFs and store in a Unity Catalog table
# MAGIC
# MAGIC **Source Location:** `/Volumes/product_agent/product_schema/customer_service/01_Data_Files/product_docs/
# MAGIC
# MAGIC **Target Table:** `product_agent.product_schema_schema.product_docs`
# MAGIC
# MAGIC **Schema:**
...
source_path = "/Volumes/product_agent/product_schema/customer_service/01_Data_Files/product_docs/"
...
table_name = "product_agent.product_schema.product_docs"
...
# MAGIC %sql
# MAGIC select * from product_agent.product_schema.product_docs